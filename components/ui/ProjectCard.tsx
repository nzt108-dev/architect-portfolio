...
export default function ProjectCard({ project }: ProjectCardProps) {
    ...
    return (
        <Link href={`/projects/${project.slug}`}>
            <article className="cyber-card p-6 h-full flex flex-col group">
                {/* Header */}
                ...
                {/* Title */}
                <h3 className="text-xl font-bold mb-2 group-hover:text-[var(--neon-cyan)] transition-colors">
                    {project.title}
                </h3>
