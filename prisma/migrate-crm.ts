...
async function migrate() {
    console.log('🚀 Adding CrmTask table to Turso...\n')
    ...
    const migrations = [
        `CREATE TABLE IF NOT EXISTS "CrmTask" (
            ...
            CONSTRAINT "CrmTask_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project" ("id") ON DELETE CASCADE ON UPDATE CASCADE
        )`,
